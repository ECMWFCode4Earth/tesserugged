...
def main():
    ...
    if args.mode == 'training':
        ...
        if args.datasource == 'minmaxnorm':
            ...
            if resolution > 0.0666666:
                ...
                valid_feature = valid_feature.interp_like(train_target,method_non_numeric='nearest')
    ...
    ##################################CALL PREDICTING################################
        ...
        files_temperature = args.pathtofeatures        
        predict.predict(inputlist, modelpath,lowtfile, hightfile, lowlsm,highlsm,cropbox,unet_name,args.datasource, file_topo, normsource,input_shape, z_branch, batch_size,normsource,normalize)
